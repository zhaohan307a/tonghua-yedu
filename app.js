...
function renderHome() {
  ...
  app.innerHTML = `
    <header class="site-header">
      ...
      <h1>童话夜读</h1>
      <p class="lead">两篇公版故事的中文整理版，配原创插画和深色护眼排版。适合手机睡前阅读，也适合电脑上慢慢翻看。</p>
    </header>
    ...
    <footer class="site-footer">
      本站不使用现代出版社译文或版式；正文为基于公版原作重新整理的中文儿童友好版本，插画为原创生成图片。
    </footer>
  `;
}
  ...
  app.innerHTML = `
    <main class="reader-shell">
      ...
      <aside class="note" id="copyright">
        版权说明：本页不复刻二十一世纪出版社、接力出版社或其他现代出版社译文；正文为基于公版原作重新整理的中文儿童友好版本，插画为原创生成图片。
      </aside>
    </main>
  `;
}
